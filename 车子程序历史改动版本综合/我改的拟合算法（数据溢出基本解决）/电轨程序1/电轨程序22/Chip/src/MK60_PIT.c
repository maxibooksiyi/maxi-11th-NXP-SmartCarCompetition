...
//==========================================================================
    void enable_pit_interrupt(uint8 pitno)
    {
      ...
      {
      case PIT0:
        enable_irq(68);			      //开接收引脚PIT0的IRQ中断
        break;
      case PIT1:
        enable_irq(69);			      //开接收引脚PIT1的IRQ中断
        break;
      case PIT2:
        enable_irq(70);			      //开接收引脚PIT2的IRQ中断
        break;
      case PIT3:
        enable_irq(71);			      //开接收引脚PIT3的IRQ中断
        break;
      }
    }
...
//==========================================================================
    void disable_pit_interrupt(uint8 pitno)
    {
      ...
      {
      case PIT0:
        disable_irq(68);	              //关接收引脚PIT0的IRQ中断
        break;
      case PIT1:
        disable_irq(69);		      //关接收引脚PIT1的IRQ中断
        break;
      case PIT2:
        disable_irq(70);		      //关接收引脚PIT2的IRQ中断
        break;
      case PIT3:
        disable_irq(71);		      //关接收引脚PIT3的IRQ中断
        break;
      }
    }