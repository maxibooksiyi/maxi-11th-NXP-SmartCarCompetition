...
#define MISO3   gpio_get(PTD6)//(GPIO_PDIR_REG(GPIOX_BASE(PTD0)) >> PTn(PTD0 )) & 0x01  
#define MOSI_H3  gpio_set(PTD4,1)//GPIO_PDOR_REG(GPIOX_BASE(PTD1))  |= (1 << PTn(PTD1))
#define MOSI_L3  gpio_set(PTD4,0)//GPIO_PDOR_REG(GPIOX_BASE(PTD1)) &= ~(1 << PTn(PTD1))
#define CSN_H3   gpio_set(PTD2,1)//GPIO_PDOR_REG(GPIOX_BASE(PTD2))  |= (1 << PTn(PTD2))
#define CSN_L3   gpio_set(PTD2,0)//GPIO_PDOR_REG(GPIOX_BASE(PTD2)) &= ~(1 << PTn(PTD2))
#define SCK_H3   gpio_set(PTD0,1)//GPIO_PDOR_REG(GPIOX_BASE(PTD3))  |= (1 << PTn(PTD3))
#define SCK_L3   gpio_set(PTD0,0)//GPIO_PDOR_REG(GPIOX_BASE(PTD3)) &= ~(1 << PTn(PTD3))
