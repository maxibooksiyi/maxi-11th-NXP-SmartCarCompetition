...
typedef enum ADC_Ch
{
    ...
    //也是 4、5、6、7
    AD4b = 36, //	    ADC0_SE4b	-- PTC2			                ADC1_SE4b   -- PTC8
    AD5b = 37, //	    ADC0_SE5b	-- PTD1			                ADC1_SE5b   -- PTC9
    AD6b = 38, //	    ADC0_SE6b	-- PTD5			                ADC1_SE6b   -- PTC10
    AD7b = 39, //	    ADC0_SE7b	-- PTD6			                ADC1_SE7b   -- PTC11
